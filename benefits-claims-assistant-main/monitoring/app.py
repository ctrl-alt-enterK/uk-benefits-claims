...
def main():
    print_log("Starting the UK Benefits and Claims Application")
    st.title("Benefit and Claims")
    ...
    print_log(f"User selected claims category: {section}")
...
if __name__ == "__main__":
    print_log("Benefit and Claims application started")
    main()